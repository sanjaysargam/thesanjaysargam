...
export default function Page() {
  ...
  rel="noopener noreferrer"
                href="/resume.pdf" className="inline-block">
...
about topics I&apos;m passionate about.
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 max-w-[1200px] mx-auto">
            {DATA.talks.map((talk, id) => (
              <BlurFade key={talk.title} delay={BLUR_FADE_DELAY * 7 + id * 0.05}>
                <TalkCard
                  title={talk.title}
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 13}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  I&apos;ve worked on a variety of projects, from building simple personal apps to complex production level apps. Here are a few of my
                  favorites.
                </p>
              </div>
            </div>
